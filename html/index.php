                ...
                <div class="upcoming-event-wrap">
                    ...
                    <div class="upcoming-event-content owl-carousel">
                        ...
                        <?php
                            ...
                            $query="SELECT * FROM event_desc where event_timestamp > NOW();";
                                ...
                                if(mysqli_num_rows($result)>0){
                                    ...
                                    while($row=mysqli_fetch_assoc($result)){
                                        ...
                                        $FTime = date_format($date,"h:i:s A");
                                    ...
                                    echo "<div class='row'>";
                                        echo "<div class='col-lg-5'>";
                                            echo "<div class='up-event-thumb'>";
                                                echo "<img src='assets/img/event/event-img-1.jpg' class='img-fluid' alt='Upcoming Event'>";
                                                echo "<h4 class='up-event-date'>It's on $Fdate at $FTime </h4>";
                                            echo "</div>";
                                        echo "</div>";
                                        ...
                                        echo "<div class='col-lg-7'>";
                                            echo "<div class='display-table'>";
                                                echo "<div class='display-table-cell'>";
                                                    echo "<div class='up-event-text'>";
                                                        echo "<div class='event-countdown'>";
                                                            echo "<div class='event-countdown-counter' data-date = '$Event_Time'></div>";
                                                            //echo "<h4 style='margin-left: 5px;font-size: 25px;'> '$Event_Time'</h4>";
                                                        echo "</div>";
                                                        
                                                        echo "<h3>$name</h3>";
                                                        echo "<p>$desc</p>";
                                                        echo "<a href='event.php' class='btn btn-brand btn-brand-dark'>join with us</a>";
                                                    echo "</div>";
                                                echo "</div>";
                                            echo "</div>";
                                        echo "</div>";
                                        ...
                                        echo "<div class='single-upcoming-event'>";
                                            echo "<div class='row'>";
                                                echo "<div class='col-lg-5'>";
                                                    echo "<div class='up-event-thumb'>";
                                                        echo "<img src='assets/img/event/event-img-1.jpg' class='img-fluid' alt='Upcoming Event'>";
                                                        echo "<h4 class='up-event-date'>No upcoming Events</h4>";
                                                    echo "</div>";
                                                echo "</div>";
                                                    ...
                                                    echo "<div class='display-table'>";
                                                        echo "<div class='display-table-cell'>";
                                                            echo "<div class='up-event-text'>";
                                                                echo "<div class='event-countdown'>";
                                                                    echo "<div ></div>";
                                                                    echo "<h4 style='margin-left: 5px;font-size: 25px;'>No Upcoming Events</h4>";
                                                                echo "</div>";
                                                                
                                                                echo "<h3><a href='single-event.html'>We are going to arrange a get together!</a></h3>";
                                                                echo "<p>Hello everybody Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim and minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquipv ex ea.</p>";
                                                                echo "<a href='single-event.html' class='btn btn-brand btn-brand-dark'>join with us</a>";
                                                                echo "</div>";
                                                            echo "</div>";
                                                        echo "</div>";
                                                    echo "</div>";
...
<section id="responsibility-area" class="section-padding">
    <div class="container">
        ...
        <div class="row text-center text-sm-left">
            ...
            <!--NEED TO WORK ON ALIGNMENT HERE -->
