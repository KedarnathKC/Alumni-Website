...
<?php
    ...
    $sql = "SELECT e.*, Count(i.alumni_id) as cnt FROM event_desc e LEFT JOIN event_info i ON e.event_id = i.event_id GROUP BY e.event_id order by e.event_timestamp desc;";
                    ...
                    <nav class="main-menu navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse" id="menucontent">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item active"><a class="nav-link" href="Event_Details.php">Event Details</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
                                    ...
                                    <div class="row">                                            
                                            <div class="register-form-wrap">
                                                ...
                                                <div class="register-form" >
                                                    <table class = "content-table" border="2" align="center" >
                                                    <tbody>
                                                    <tr>
                                                    <th style="width:1%;">Event Name</th>
                                                    <th style="width:1%;">Event Location</th>
                                                    <th style="width:4%;">Event Desc</th>
                                                    <th style="width:2%;">Event Date</th>
                                                    <th style="width:1%;">Event Time</th>
                                                    <th style="width:1%;">People Interested</th>
                                                    
                                                    <td style="width:1%;">Edit</td>
                                                    </tr>
                                                    <?php 
                                                    ...
                                                    while($row=mysqli_fetch_array($result_set))
                                                    {
                                                        ...
                                                        <td><a href="Edit_Events.php?eid=<?php echo $id; ?>" target="">Edit</a></td>
                                                        </tr>
                                                        <?php
                                                    }
                                                        ?>
