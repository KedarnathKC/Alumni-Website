...
<script>
    ...
    function ValidateFPForm(){
            ...
            var email=document.FPForm.email.value;            
                        ...
                        <div class="register-page-inner">
                            <div class="col-lg-10 m-auto">
                                ...
                                <div class="forgot-pass">
                                    ...
                                    <form name="FPForm" onsubmit="return ValidateFPForm()" action="Forgot_password2.php" method="POST" ><!--action="https://codeboxr.net/themedemo/unialumni/html/index.html"-->
                                        <input type="text" placeholder="Enter Your Email" name="email"  data-placement="bottom" data-tooltip title="Enter your registered mail id! We will send an OTP!" required><br><br>
                                        <center><button type="submit" class="btn btn-reg" name="forgot_email">Submit</button></center><br>
                                    </form>
                                </div>  
                                </div>
                            </div>
