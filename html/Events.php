            ...
            <div class="row">
                <div class="col-lg-6 col-sm-7 col-7">
                    <div class="preheader-left">
                        <a href="mailto:info@construc.com"><strong>Email:</strong> Gaurav.Sangwan0@gmail.com</a>
                            ...
                            <div class="col-lg-10 m-auto">
                                <div class="register-form-content">
                                    <div class="row">
                                                ...
                                                <div style="height: 300px;width:900px; border: solid 2px black;">
                                                    
                                                                         
                                                <?php
                                                    $get_events="select * from event_desc where event_date>='$date' ";
                                                    ...
                                                    if(@mysqli_num_rows($result)>0){
                                                        while($row=mysqli_fetch_assoc($result)){
                                                            echo "<form method='POST' action='event_register.php'>";
                                                                ...
                                                                echo "<div style='text-align:center;border:solid 2px black;height:300px;color:white;background: url(Background2.jpg);opacity: 0.9;float:left;width:50%;'>";
                                                                echo "<h6>Name :".$row["event_name"]."</h6><br>";
                                                                
                                                                echo "<h6>Date :".$row["event_date"]."</h6><br>";
                                                                echo "<h6>Time :".$row["event_time"]."</h6><br>";
                                                                echo "<h6>Description :".$row["description"]."</h6><br>";

                                                                if(in_array($row["event_id"],$registered))
                                                                    echo "<input type='button' name='event_reg' value='Registered' readonly>";
                                                                else
                                                                    echo "<input type='Submit' name='event_reg' value='Interested'>";
                                                            echo "</div>";
                                                            echo "</form>"    ;
