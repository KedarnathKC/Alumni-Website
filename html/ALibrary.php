...
<script>
    ...
    function ValidateLibraryForm(){
            ...
            var bname=document.LibraryForm.bname.value;
            var aname=document.LibraryForm.author.value;
            var yop=document.LibraryForm.yop.value;
            
            
            if(bname.length>100)
            {
                alert("Please Enter Valid Book Name! Max length allowed is 100!");
                return false;   
            }
            
            if(aname.length>100)
            {
                alert("Please Enter Valid Author name! Max length allowed is 100!");
                return false;
            }
            var current_year=new Date().getFullYear();
            if(yop>current_year)
            {
                alert("Please Enter Valid Year of Publication!");
                return false;
            }
                    ...
                    <nav class="main-menu navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse" id="menucontent">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item active"><a class="nav-link" href="ALibrary.php">Upload</a></li>
                                ...
                                <div class="register-form-content">
                                    <div class="row">                                        
                                            <div class="register-form-wrap">
                                                <h3 style="text-align: center;margin-left: 350px;">Library Page</h3>
                                                <div class="register-form" style="width: 500px;margin-left: 40%;">
                                                    <form name="LibraryForm" onsubmit="return ValidateLibraryForm()" action="AdLibrary.php" method="POST" enctype="multipart/form-data">
                                                        <div class="form-group">
                                                        <label for="bookName">File/Book Name</label>
                                                        <input type="text" class="form-control" id="bookName" name="bname"  placeholder="Enter Book Name" data-placement="bottom" data-tooltip title="Max length is 100" required>
                                                       
                                                      </div>
                                                      <div class="form-group">
                                                        <label for="authorName">Author Name</label>
                                                        <input type="text" class="form-control" id="authorName" name="author" data-placement="bottom" data-tooltip title="Max length is 100"     placeholder="Enter Author Name" required>
                                                       
                                                      </div>
                                                      
                                                      <div class="form-group">
                                                        <label for="yop">Year of Publication</label>
                                                        <input type="text" name="yop" class="form-control" id="yop"  placeholder="Enter year of publication" required>
                                                       
                                                      </div>
                                                      <div class="form-group">
                                                        <input type="file" name="upload" value="Upload File" >
                                                            <label class="custom-file" for="customfile"><i class="fa fa-upload"></i>Upload Material</label>
                                                       
                                                      </div>
                                                      <center><input type="submit" class="btn btn-reg" value="Upload" name="upld"></center>
                                                    </form>
                                                </div>
                                            </div>
